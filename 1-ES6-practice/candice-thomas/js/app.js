...
function displayPics(){
  ...
  // the variable rando was declared within a previous code block and is local to that block only. The console log is calling the variable outside of its block scope
  console.log(viewed)
